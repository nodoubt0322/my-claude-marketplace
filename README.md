...
Personal Claude Code plugin marketplace for Daniel Huang.

## Register

```
/plugin marketplace add nodoubt0322/my-claude-marketplace
```
...
|--------|-------------|--------|
| [superpowers](https://github.com/obra/superpowers) | Core skills: TDD, debugging, collaboration patterns | Jesse Vincent |
...
| [taste-skill](https://github.com/Leonxlnx/taste-skill) | Anti-slop frontend design skill for landing pages, portfolios, and redesigns | Leon |

## Install a Plugin

```
/plugin install <name>@my-claude-marketplace
```

Example:

```
/plugin install superpowers@my-claude-marketplace
```
